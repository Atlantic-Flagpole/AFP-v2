            ...
            <div className="container mx-auto px-4 flex items-center justify-between">
                ...
                <nav className="hidden lg:flex items-center gap-10">
                    ...
                    <a
                        ...
                        className={`hidden xl:flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] hover:text-accent transition-colors ${isScrolled ? 'text-navy' : 'text-white'}`}
                    >
