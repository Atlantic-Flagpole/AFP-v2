                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex gap-4">
                            <div className="flex gap-4">
                                ...
                                <a href={BRAND_CONFIG.social.facebook} target="_blank" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                                </a>
                                <a href={BRAND_CONFIG.contact.phoneClick} className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
